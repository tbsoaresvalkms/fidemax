...
import { ItemProductComponent } from 'app/entities/item-product/item-product.component';
...
describe('Component Tests', () => {
    describe('ItemProduct Management Component', () => {
        let comp: ItemProductComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ItemProductComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.itemProducts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
