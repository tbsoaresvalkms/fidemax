...
import { RedemptionTransactionComponent } from 'app/entities/redemption-transaction/redemption-transaction.component';
...
describe('Component Tests', () => {
    describe('RedemptionTransaction Management Component', () => {
        let comp: RedemptionTransactionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RedemptionTransactionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new RedemptionTransaction(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.redemptionTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
