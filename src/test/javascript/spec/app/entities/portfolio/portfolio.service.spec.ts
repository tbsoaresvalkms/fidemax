    ...
    describe('Portfolio Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/portfolios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Portfolio', () => {
                service.create(new Portfolio(null)).subscribe(received => {
            ...
            it('should update a Portfolio', () => {
                service.update(new Portfolio(123)).subscribe(received => {
