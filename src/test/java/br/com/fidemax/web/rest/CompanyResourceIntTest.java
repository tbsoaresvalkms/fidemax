...
public class CompanyResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllCompaniesByCnpjIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);

        // Get all the companyList where cnpj equals to DEFAULT_CNPJ
        defaultCompanyShouldBeFound("cnpj.equals=" + DEFAULT_CNPJ);

        // Get all the companyList where cnpj equals to UPDATED_CNPJ
        defaultCompanyShouldNotBeFound("cnpj.equals=" + UPDATED_CNPJ);
    }

    @Test
    @Transactional
    public void getAllCompaniesByCnpjIsInShouldWork() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);

        // Get all the companyList where cnpj in DEFAULT_CNPJ or UPDATED_CNPJ
        defaultCompanyShouldBeFound("cnpj.in=" + DEFAULT_CNPJ + "," + UPDATED_CNPJ);

        // Get all the companyList where cnpj equals to UPDATED_CNPJ
        defaultCompanyShouldNotBeFound("cnpj.in=" + UPDATED_CNPJ);
    }

    @Test
    @Transactional
    public void getAllCompaniesByCnpjIsNullOrNotNull() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);

        // Get all the companyList where cnpj is not null
        defaultCompanyShouldBeFound("cnpj.specified=true");

        // Get all the companyList where cnpj is null
        defaultCompanyShouldNotBeFound("cnpj.specified=false");
    }

    @Test
    @Transactional
    public void getAllCompaniesByConsumerTransactionIsEqualToSomething() throws Exception {
        // Initialize the database
        ConsumerTransaction consumerTransaction = ConsumerTransactionResourceIntTest.createEntity(em);
        em.persist(consumerTransaction);
        em.flush();
        company.addConsumerTransaction(consumerTransaction);
        companyRepository.saveAndFlush(company);
        Long consumerTransactionId = consumerTransaction.getId();

        // Get all the companyList where consumerTransaction equals to consumerTransactionId
        defaultCompanyShouldBeFound("consumerTransactionId.equals=" + consumerTransactionId);

        // Get all the companyList where consumerTransaction equals to consumerTransactionId + 1
        defaultCompanyShouldNotBeFound("consumerTransactionId.equals=" + (consumerTransactionId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByRedemptionTransactionIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        em.flush();
        company.addRedemptionTransaction(redemptionTransaction);
        companyRepository.saveAndFlush(company);
        Long redemptionTransactionId = redemptionTransaction.getId();

        // Get all the companyList where redemptionTransaction equals to redemptionTransactionId
        defaultCompanyShouldBeFound("redemptionTransactionId.equals=" + redemptionTransactionId);

        // Get all the companyList where redemptionTransaction equals to redemptionTransactionId + 1
        defaultCompanyShouldNotBeFound("redemptionTransactionId.equals=" + (redemptionTransactionId + 1));
    }
