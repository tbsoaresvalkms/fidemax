...
import { ConsumerTransactionService } from 'app/entities/consumer-transaction';
...
export class EmployeeUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.consumerTransactionService.query().subscribe(
            (res: HttpResponse<IConsumerTransaction[]>) => {
                this.consumertransactions = res.body;
            },
            (res: HttpErrorResponse) => this.onError(res.message)
        );
    ...
    trackConsumerTransactionById(index: number, item: IConsumerTransaction) {
        return item.id;
    }
